...
App.demo = (function () {
  ...
  function seed() {
    ...
    DB.profiles.push({ id: DEMO_USER.id, email: DEMO_USER.email, full_name: 'Demo User', preferred_currency: 'INR', financial_year_start_month: 4, financial_year_start_day: 1, timezone: 'Asia/Kolkata', created_at: nowIso(), updated_at: nowIso() });
